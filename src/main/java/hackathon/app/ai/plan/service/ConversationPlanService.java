...
public class ConversationPlanService {
    ...
    public ConversationTurnResponse turn(Long userId, String conversationId, MessageRequest request) {
        ...
        conversationService.requireActive(userId, conversationId);
        ...
        Long scheduleId = turnPersistenceService.persist(userId, conversationId, request, result);
        ...
        return new ConversationTurnResponse(
                ...
                submitted, result.feedback_history(), scheduleId);
    }
}
